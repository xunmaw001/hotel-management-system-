    ...
    >
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="服务费用" prop="fuwufeiyong">
          <el-input v-model="ruleForm.fuwufeiyong" 
              placeholder="服务费用" clearable  :readonly="ro.fuwufeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务费用" prop="fuwufeiyong">
              <el-input v-model="ruleForm.fuwufeiyong" 
                placeholder="服务费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item class="input" label="时间段" prop="shijianduan">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fuwuxiangqing" label="服务详情" prop="fuwuxiangqing">
                    <span v-html="ruleForm.fuwuxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kefangfuwu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kefangfuwuCrossAddOrUpdateFlag = false;
                  this.parent.search();
