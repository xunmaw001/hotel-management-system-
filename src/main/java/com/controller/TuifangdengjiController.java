...
public class TuifangdengjiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,TuifangdengjiEntity tuifangdengji, HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			tuifangdengji.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,TuifangdengjiEntity tuifangdengji, HttpServletRequest request){
        EntityWrapper<TuifangdengjiEntity> ew = new EntityWrapper<TuifangdengjiEntity>();
		PageUtils page = tuifangdengjiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, tuifangdengji), params), params));
        return R.ok().put("data", page);
    }
